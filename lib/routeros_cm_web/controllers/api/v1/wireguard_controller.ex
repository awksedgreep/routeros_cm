defmodule RouterosCmWeb.API.V1.WireGuardController do
  ...
  operation(:index,
    ...
    responses: [
      ok:
        {"WireGuard interface list", "application/json",
         %Schema{
           type: :object,
  ...
  operation(:show,
    ...
    responses: [
      ok:
        {"WireGuard interface", "application/json",
         %Schema{
           type: :object,
  ...
  operation(:create,
    ...
    request_body:
      {"WireGuard interface parameters", "application/json",
       %Schema{
         type: :object,
         required: [:name],
         properties: %{
           ...
           "private-key": %Schema{
             type: :string,
             description: "Private key (auto-generated if not provided)"
           }
         }
       }},
    responses: [
  ...
  operation(:create_peer,
    ...
    request_body:
      {"Peer parameters", "application/json",
       %Schema{
         type: :object,
  ...
  operation(:delete_peer,
    ...
    parameters: [
      ...
      public_key: [
        in: :path,
        type: :string,
        description: "Peer's public key (URL-encoded)",
        required: true
      ]
    ],
    responses: [
